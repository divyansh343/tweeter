...
import { detectUrls } from "../functions";

const Tweet = ({ text }) => {
  // detecting urls in the text
  const tweet = detectUrls(text);
  ...
  return (
    <div class="w-full max-w-xl border border-gray-300 rounded-2xl py-3 px-5 bg-white">
      <div class="flex">
        <div class="mr-2">
          <img
            class="rounded-full"
        ...
        <div>
          <div class="flex space-x-1">
            <span class="font-bold">Elon Musk</span>
          ...
          <div class="text-gray-500 leading-4">@elonmusk</div>
        </div>
      ...
      <div class="py-3">
        <span class="text-lg pre my-2" id="element"></span>
        <div class="flex">
          <p class="text-gray-500 pt-1">1:57 PM · Feb 4, 2021</p>
          <svg
